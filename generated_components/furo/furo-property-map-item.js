 ...
 * @appliesMixin FBP
 */
export class FuroPropertyMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <furo-property-form ƒ-bind-data="--data" ƒ-focus="--focused"></furo-property-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('furo-property-map-item', FuroPropertyMapItem);
