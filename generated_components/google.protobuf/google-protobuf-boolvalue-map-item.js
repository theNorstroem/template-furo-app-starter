 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBoolvalueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-boolvalue-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-boolvalue-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-boolvalue-map-item', GoogleProtobufBoolvalueMapItem);
