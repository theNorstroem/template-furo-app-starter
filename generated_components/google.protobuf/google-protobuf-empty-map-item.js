 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufEmptyMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-empty-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-empty-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-empty-map-item', GoogleProtobufEmptyMapItem);
