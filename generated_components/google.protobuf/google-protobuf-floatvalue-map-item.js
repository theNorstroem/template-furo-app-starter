 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFloatvalueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-floatvalue-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-floatvalue-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-floatvalue-map-item', GoogleProtobufFloatvalueMapItem);
