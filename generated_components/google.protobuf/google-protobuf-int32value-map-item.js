 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt32valueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-int32value-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-int32value-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-int32value-map-item', GoogleProtobufInt32valueMapItem);
