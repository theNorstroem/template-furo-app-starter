 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint32valueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-uint32value-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-uint32value-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-uint32value-map-item', GoogleProtobufUint32valueMapItem);
