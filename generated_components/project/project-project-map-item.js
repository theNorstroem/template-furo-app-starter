 ...
 * @appliesMixin FBP
 */
export class ProjectProjectMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <project-project-form ƒ-bind-data="--data" ƒ-focus="--focused"></project-project-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('project-project-map-item', ProjectProjectMapItem);
