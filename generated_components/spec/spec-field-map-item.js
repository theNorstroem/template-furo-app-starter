 ...
 * @appliesMixin FBP
 */
export class SpecFieldMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <spec-field-form ƒ-bind-data="--data" ƒ-focus="--focused"></spec-field-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('spec-field-map-item', SpecFieldMapItem);
