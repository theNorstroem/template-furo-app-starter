 ...
 * @appliesMixin FBP
 */
export class SpecFieldprotoMapItem extends FBP(LitElement) {
  /**
   * @private
   * @return {Object}
   */
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey ? this.mapKey : ''}">
        ...
        <spec-fieldproto-form ƒ-bind-data="--data" ƒ-focus="--focused"></spec-fieldproto-form>
      </furo-form>
    `;
  }
}

window.customElements.define('spec-fieldproto-map-item', SpecFieldprotoMapItem);
