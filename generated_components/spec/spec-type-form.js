    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: __proto -->
          <spec-typeproto-form condensed full header-text="${i18n.t('spec.typeproto.form.header.text')}" secondary-text="${i18n.t('spec.typeproto.form.secondary.text')}" ƒ-bind-data="--data(*.__proto)"></spec-typeproto-form> 

          <!-- field: fields -->
          <spec-field-map full ƒ-bind-data="--data(*.fields)"></spec-field-map> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
