 ...
 * @appliesMixin FBP
 */
export class SpecTypeMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <spec-type-form ƒ-bind-data="--data" ƒ-focus="--focused"></spec-type-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('spec-type-map-item', SpecTypeMapItem);
