 ...
 * @appliesMixin FBP
 */
export class SpecTypeUpdateAction extends FBP(LitElement) {
  ...
  static get styles() {
    // language=CSS
    return Theme.getThemeForComponent("SpecTypeUpdateAction") || css`
...
window.customElements.define('spec-type-update-action', SpecTypeUpdateAction);
