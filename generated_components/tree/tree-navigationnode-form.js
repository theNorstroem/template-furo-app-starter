    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: children -->
          <furo-data-repeat condensed full header-text="${i18n.t('tree.navigationnode.form.header.text')}" repeated-component="tree-navigationnode-form" secondary-text="${i18n.t('tree.navigationnode.form.secondary.text')}" ƒ-bind-data="--data(*.children)"></furo-data-repeat> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
