 ...
 * @appliesMixin FBP
 */
export class TreeTreeMapItem extends FBP(LitElement) {
  /**
   * @private
   * @return {Object}
   */
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey ? this.mapKey : ''}">
        ...
        <tree-tree-form ƒ-bind-data="--data" ƒ-focus="--focused"></tree-tree-form>
      </furo-form>
    `;
  }
}

window.customElements.define('tree-tree-map-item', TreeTreeMapItem);
