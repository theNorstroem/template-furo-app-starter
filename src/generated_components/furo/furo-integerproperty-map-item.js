 ...
 * @appliesMixin FBP
 */
export class FuroIntegerpropertyMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <furo-integerproperty-form ƒ-bind-data="--data" ƒ-focus="--focused"></furo-integerproperty-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('furo-integerproperty-map-item', FuroIntegerpropertyMapItem);
