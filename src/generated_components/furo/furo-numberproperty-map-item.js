 ...
 * @appliesMixin FBP
 */
export class FuroNumberpropertyMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <furo-numberproperty-form ƒ-bind-data="--data" ƒ-focus="--focused"></furo-numberproperty-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('furo-numberproperty-map-item', FuroNumberpropertyMapItem);
