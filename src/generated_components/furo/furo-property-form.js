      ...
      >
        ...
        <furo-form-layouter four>
          ...
          <furo-meta-form
            condensed
            full
            header-text="${i18n.t('form.furo.property.meta.header.text')}"
            secondary-text="${i18n.t('form.furo.property.meta.secondary.text')}"
