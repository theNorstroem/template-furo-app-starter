 ...
 * @appliesMixin FBP
 */
export class FuroStringpropertyMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <furo-stringproperty-form ƒ-bind-data="--data" ƒ-focus="--focused"></furo-stringproperty-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('furo-stringproperty-map-item', FuroStringpropertyMapItem);
