 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBytesvalueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-bytesvalue-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-bytesvalue-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-bytesvalue-map-item', GoogleProtobufBytesvalueMapItem);
