      ...
      >
        ...
        <furo-form-layouter four>
          ...
          <string-repeat
            condensed
            double
            header-text="${i18n.t('form.google.protobuf.fieldmask.paths.header.text')}"
            secondary-text="${i18n.t('form.google.protobuf.fieldmask.paths.secondary.text')}"
            ƒ-bind-data="--data(*.paths)"
            ƒ-focus="--focused"
          ></string-repeat>
        </furo-form-layouter>
      </furo-form>
