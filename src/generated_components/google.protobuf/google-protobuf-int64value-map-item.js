 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt64valueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-int64value-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-int64value-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-int64value-map-item', GoogleProtobufInt64valueMapItem);
