 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufStringvalueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-stringvalue-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-stringvalue-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-stringvalue-map-item', GoogleProtobufStringvalueMapItem);
