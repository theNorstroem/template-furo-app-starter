 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint64valueMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <google-protobuf-uint64value-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-protobuf-uint64value-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('google-protobuf-uint64value-map-item', GoogleProtobufUint64valueMapItem);
