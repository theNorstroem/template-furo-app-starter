 ...
 * @appliesMixin FBP
 */
export class GoogleTypeDateMapItem extends FBP(LitElement) {
  /**
   * @private
   * @return {Object}
   */
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey ? this.mapKey : ''}">
        ...
        <google-type-date-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-type-date-form>
      </furo-form>
    `;
  }
}

window.customElements.define('google-type-date-map-item', GoogleTypeDateMapItem);
