 ...
 * @appliesMixin FBP
 */
export class GoogleTypeMoneyMapItem extends FBP(LitElement) {
  /**
   * @private
   * @return {Object}
   */
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey ? this.mapKey : ''}">
        ...
        <google-type-money-form ƒ-bind-data="--data" ƒ-focus="--focused"></google-type-money-form>
      </furo-form>
    `;
  }
}

window.customElements.define('google-type-money-map-item', GoogleTypeMoneyMapItem);
