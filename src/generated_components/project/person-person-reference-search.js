...
export class PersonPersonReferenceSearch extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-data-reference-search ?condensed="$(this.condensed)" display-field="display_name" min-term-length="1" value-field="id" @-search="--term" ƒ-bind-data="--field-injected" ƒ-collection-in="--collection" ƒ-focus="--focused"></furo-data-reference-search> 

      <!-- It is a good practice to set a description -->
      <furo-collection-agent service="ProjectMembersService" @-response="--collection" ƒ-hts-in="--field-injected(*.link._value), --htsUpdated" ƒ-search="--term"></furo-collection-agent> 
    `;
  }
}
