 ...
 * @appliesMixin FBP
 */
export class SpecFieldprotoCreateWidget extends FBP(LitElement) {
  // Fokus
  focus(d) {
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('CreateWidgetBaseTheme') ||
      css`
        :host {
          display: block;
        }
...
window.customElements.define('spec-fieldproto-create-widget', SpecFieldprotoCreateWidget);
