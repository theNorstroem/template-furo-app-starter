      ...
      >
        ...
        <furo-form-layouter four>
          ...
          <spec-typeproto-form
            condensed
            full
            header-text="${i18n.t('form.spec.type.__proto.header.text')}"
            secondary-text="${i18n.t('form.spec.type.__proto.secondary.text')}"
          ...
          <spec-field-map
            full
            header-text="${i18n.t('form.spec.type.fields.header.text')}"
            secondary-text="${i18n.t('form.spec.type.fields.secondary.text')}"
            ƒ-bind-data="--data(*.fields)"
          ></spec-field-map>
        </furo-form-layouter>
      </furo-form>
    `;
