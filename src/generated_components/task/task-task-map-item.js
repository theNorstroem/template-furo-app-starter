 ...
 * @appliesMixin FBP
 */
export class TaskTaskMapItem extends FBP(LitElement) {
  /**
   * @private
   * @return {Object}
   */
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey ? this.mapKey : ''}">
        ...
        <task-task-form ƒ-bind-data="--data" ƒ-focus="--focused"></task-task-form>
      </furo-form>
    `;
  }
}

window.customElements.define('task-task-map-item', TaskTaskMapItem);
