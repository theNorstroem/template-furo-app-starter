 ...
 * @appliesMixin FBP
 */
export class TreeNavigationnodeMapItem extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-form header-text="${this.mapKey?this.mapKey:""}">
        ...
        <tree-navigationnode-form ƒ-bind-data="--data" ƒ-focus="--focused"></tree-navigationnode-form> 
      </furo-form> 
    `;
  }
}

window.customElements.define('tree-navigationnode-map-item', TreeNavigationnodeMapItem);
