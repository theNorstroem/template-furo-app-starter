{
  ...
  "class_name": "ExperimentConstraintsCreateWidget",
  "component_name": "experiment-constraints-create-widget",
  ...
  "source": "specs/experiment/experiment.constraints.type.spec"
}