{
  ...
  "class_name": "ProjectfilterProjectfilterCreateWidget",
  "component_name": "projectfilter-projectfilter-create-widget",
  ...
  "source": "specs/projectfilter/projectfilter.type.spec"
}